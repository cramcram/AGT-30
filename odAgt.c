	...
	for (i = 0; i < ((inputSize + 3) % 4); i++)
	{
		...
		if ((i % 4) == 3)
		{
			fprintf(outputStream, "% 5d: %010o %010o %010o %010o %s%s%s%s\n",
				...
				amosName2Ascii(octalWords[0], octalStrBuf[0],
					amosWord2Ascii),
				amosName2Ascii(octalWords[1], octalStrBuf[1],
					amosWord2Ascii),
				amosName2Ascii(octalWords[2], octalStrBuf[2],
					amosWord2Ascii),
				amosName2Ascii(octalWords[3], octalStrBuf[3]),
					amosWord2Ascii);
		}
	}
